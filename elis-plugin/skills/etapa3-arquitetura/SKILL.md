...
Se o julgamento já foi definido na Etapa 2, confirmar com o usuário antes de prosseguir.
...
## ✅ CRITÉRIOS PARA AVANÇAR PARA A ETAPA 4 (MINUTA DA SENTENÇA)
...
3. Sugerir explicitamente a próxima fase: **"O plano da sentença está pronto. Deseja prosseguir para a Etapa 4 (Sentença Final)? Use `/elis:etapa4` ou diga 'prossiga'."**
