...
**Comando de ativação**: `"Faça a engenharia de contexto do processo [REFERÊNCIA]"` ou `/elis:iniciar [REFERÊNCIA]`
...
- **Skill**: `elis:etapa1-analise-firac` | **Comando**: `/elis:etapa1`
...
- **Skill**: `elis:etapa1-5-liminar-rp` | **Comando**: `/elis:liminar`
...
### Etapa 2: Deliberação
- **Skill**: `elis:etapa2-deliberacao` | **Comando**: `/elis:etapa2 [procedencia|improcedencia]`
...
- **Skill**: `elis:etapa3-arquitetura` | **Comando**: `/elis:etapa3`
...
- **Skill**: `elis:etapa4-sentenca` | **Comando**: `/elis:etapa4`
...
- Ao concluir: oferecer `/elis:finalizar`.
...
Acionada por `"Finalize o processo"` ou `/elis:finalizar`:
...
|------|-------------------|---------|
| Iniciar | "Faça a engenharia de contexto do processo [REF]" | `/elis:iniciar [REF]` |
| Tutela de urgência | "Execute a tutela de urgência" / "Analise o pedido liminar" | `/elis:liminar` |
| Ajustar | "Faça os seguintes ajustes: [DESC]" | — |
| Prosseguir | "Prossiga para a próxima etapa" | `/elis:etapa2` … `/elis:etapa4` |
| Análise oposta | "Faça a análise pelo julgamento oposto" | — |
| Finalizar | "Finalize o processo" | `/elis:finalizar` |
