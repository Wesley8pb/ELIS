...
1. **VARRER** o índice embarcado (`${CLAUDE_PLUGIN_ROOT}/skills/templates-sentenca/INDICE.md`) e a pasta `TEMPLATES/` local da área de trabalho (se existir)
...
3. Sugerir explicitamente a finalização: **"Deseja finalizar o processo e arquivar os artefatos? Use `/elis:finalizar` ou diga 'finalize o processo'."**
