...
2. Sugerir explicitamente a próxima fase do fluxo ELIS: **"Deseja prosseguir para a Etapa 2 (Deliberação — `/elis:etapa2`) ou ir direto para a Etapa 3 (Arquitetura da Sentença — `/elis:etapa3`)?"**
...
**Versão:** 2.1
**Skill:** etapa1-5-liminar-rp (fluxo ELIS)
