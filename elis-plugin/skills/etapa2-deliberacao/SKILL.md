...
3. Sugerir explicitamente a próxima fase: **"Com base nesta análise probatória, os elementos estão organizados para estruturar a linha argumentativa da sentença. Deseja prosseguir para a Etapa 3 (Arquitetura da Sentença)? Use `/elis:etapa3` ou diga 'prossiga'."**
