...
Apresente o resultado como um **Artefato** intitulado **"ELIS — Decisão Liminar (RP)"**. Ao final, inclua o aviso obrigatório de IA generativa.

Em seguida:
1. Pergunte ao usuário se deseja **ajustes**.
2. Pergunte se o usuário deseja seguir para a **Etapa 2 (Deliberação)** ou diretamente para a **Etapa 3 (Arquitetura)**.
